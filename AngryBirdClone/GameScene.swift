...
//  AngryBirdClone
//
//  Created by Doğukan Temizyürek on 25.07.2023.
//
...
class GameScene: SKScene , SKPhysicsContactDelegate {
   ...
   // var bird2 = SKSpriteNode()
    ...
    override func update(_ currentTime: TimeInterval)
    {
        ...
        {
            if birdPhysicsBody.velocity.dx <= 01 && birdPhysicsBody.velocity.dy <= 0.1 && birdPhysicsBody.angularVelocity <= 0.1 && gameStarted == true
            {
                bird.physicsBody?.affectedByGravity = false
